...
dataset = pd.read_csv(r"C:\Users\phara\Desktop\S8\Customer Churn Prediction - RealData\Customer Churn Prediction\SOURCE CODE\Customer Churn\dataset\Churn_Modelling.csv")
